...
export class Contact extends Component {
    render() {
        return (
            <div className="contact-area section-padding home-3-contact-area"
                id="contact-form" >
                <div className="container" >
                    <div className="row justify-content-center aic" >
                        ...
                        <div className="col-lg-5 offset-lg-1 wow fadeInRight" data-wow-delay="0.4s" data-wow-duration="1s" >
