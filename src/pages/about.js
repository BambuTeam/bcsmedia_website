          ...
          <div className="row justify-content-center">
            <div className="col-lg-7 text-center">
              ...
              >
                ...
                <p>
                  Trabajamos en consegir el alcance e impacto entre tu mensaje y
                  los grupos objetivos, identificando los puntos estratégicos de
                  mayor influencia para generar un mayor impacto, asegurándonos
                  que tu anuncio llegue al público de una manera precisa y
                  eficaz.
                </p>
              </div>
            </div>
